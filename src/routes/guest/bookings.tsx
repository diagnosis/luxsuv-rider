...
import { listGuestBookings } from '../../api/guestBookings'
import type { BookingStatus } from '../../types/booking'

export const Route = createFileRoute('/guest/bookings')({
  component: GuestBookingsListPage,
})

function GuestBookingsListPage() {
  ...
  const bookingsQuery = useQuery({
    queryKey: ['guest-bookings', filters],
    queryFn: () => listGuestBookings(filters.status ? { ...filters, status: filters.status } : filters),
  })
        ...
        <div className="bg-white rounded-lg shadow-md">
          <div className="p-6 border-b border-gray-200">
            <div className="flex justify-between items-center mb-4">
              <h1 className="text-2xl font-bold text-gray-900">All Guest Bookings</h1>
              <div className="text-sm text-gray-500 bg-yellow-50 border border-yellow-200 px-3 py-1 rounded">
                Development View
              </div>
            </div>
